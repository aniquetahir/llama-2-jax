...
if __name__ == "__main__":
    ...
    dataset = AlpacaDataset(split='train', path=TRAIN_DATA_PATH, tokenizer=tokenizer, max_len=max_len)
    ...
    with jax.default_device(cpu_device):
        params = load_params(INIT_PARAMS_PATH)
    ...
    LORA_SAVE_PATH = 'phase2_params/final_lora.pkl'

    with open(LORA_SAVE_PATH, 'wb') as save_file:
        pickle.dump(lora_params, save_file)
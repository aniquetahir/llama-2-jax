...
from lib.model import Llama, llama_model, model_config_llama2_7B,llama_model_lora, model_config_llama2_13B
...
def main() -> None:
    ...
    for epoch in tqdm(range(n_epochs)):
        ...
        with open(f'lora_phase2_epoch_{epoch}.pickle', 'wb') as f:
            pickle.dump(lora_params, f)

    with open(f'lora_phase2_final.pickle', 'wb') as f:
        pickle.dump(lora_params, f)
